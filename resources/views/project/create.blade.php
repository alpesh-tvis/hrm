            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        @endif    
                            <div class="project-details">
                               <div class="project-bg">
                                  <h3 class="font-weight-bolder mb-0">Project Details</h3>
                                    <div class="p-4">
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Bid</label>
                                                    <select name="bid_id" class="form-control bid-list">
                                                        <option value="">-- Select Bid --</option>

                                                        @foreach($bids as $bid)
                                                            <option value="{{ $bid->id }}" {{ isset($project) && $project->bid_id == $bid->id ? 'selected' : '' }}>
                                                                {{ $bid->bid_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Client</label>
                                                    <select name="client_id" class="form-control client-list">
                        ...
                        <div class="project-bg">
                                <h3 class="font-weight-bolder mb-0">Live Details</h3>
                                 <div class="p-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <h5 class="font-weight-bolder mt-3 mb-4">Admin Details(Live)</h5>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <h5 class="font-weight-bolder mt-3 mb-4">Database Details(Live)</h5>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <h5 class="font-weight-bolder mt-3 mb-4">Domain Host Details(Live)</h5>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="database_url">URL</label>
                                   ...
                                   <h5 class="font-weight-bolder mt-3 mb-4">Cpanel/Hosting Details(Live)</h5>
                                     <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                 ...
                                 <h5 class="font-weight-bolder mt-3 mb-4">Credentials Details(Live)</h5> 
                                    <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
