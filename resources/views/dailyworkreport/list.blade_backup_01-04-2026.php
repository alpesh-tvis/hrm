        ...
        <div class="row info-detail ">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="small-box">
                    ...
                    <div class="icon">
                        <img src="{{asset('public/img/office-icon.png')}}">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="small-box ">
                    ...
                    <div class="icon">
                        <img src="{{asset('public/img/hours-icon.png')}}">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="small-box ">
                    ...
                    <div class="icon">
                        <img src="{{asset('public/img/break-icon.png')}}">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="small-box">
                    ...
                    <div class="icon">
                        <img src="{{asset('public/img/wheek-icon.png')}}">
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card-primary task_row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row project-work" style="display: none;">
                                                ...
                                                <div class="col-md-4 u_timer" style="display:none">
                                                    <div class="form-group">
                                                        <label for="emp_ids">Timers</label>
                                                        <div class="u_timer_select">
                                                        </div>    
                                                    </div>
                                                </div>
        ...
        <table id="work_report" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if(!empty($work->work_time) )
                            @if(empty($enddate))
                                @if(empty($_GET))
                                    @if($sift_count < 10)
                                        <form action="{{ route('daily_work_report.store')}}" method="post" style="display:inline" onsubmit="return confirm('Are you sure you want to Start this Activity?');">
                                            {{csrf_field()}}
                                            <input type="hidden" name="start_activity" value="{{$work->id}}">
                                            <button class="btn-primary-rv show-alert-delete-box start-btn" name="start_act_smt" type="submit">Start</button>
                    ...
                    <!--Modal: Daily work report edit-->
                    <div id="edit-modal-{{$work->id}}" class="modal fade modal-top-right" tabindex="-1" role="dialog" aria-labelledby="edit-modal-{{$work->id}}" aria-hidden="true">
                        <div class="modal-dialog modal-top-right">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="">Update Description : Daily Work Report</h5>
                                ...
                                <form  method="post" action="{{ route('daily_work_report.update',$work->id) }}" name="edit_dailywork_report_edit" id="edit_dailywork_report_edit" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group description">
                                                        ...
                                                        <textarea type="text" class="form-control" id="description" name="description">{{$work->description ? $work->description : ''}}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" id="daily_work_report_submit" class="btn btn-primary">Update</button>
                                    </div>
                                </form> 
                    ...
                    <!---END Daily work report edit-->
                    <a href="#edit-modal-{{$work->id}}" class="btn btn-info btn-success" data-toggle="modal"> 
...
@endsection
<link rel="stylesheet" href="https://hrm.tvistech.com/public/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    ...
    jQuery("select[name='activity_type1']").on("change", function() {
        ...
        if(option == '1'){
            ...
            $.ajax({
                ...
                data : { id: project_id},
                url: '/daily_work_report/' + project_id,
                type: "GET",
                beforeSend: function() {
                    // if(user_id == '14'){
                        if(project_id != 'o1'){
