...
<html>
    ...
    <?php
        ...
        // TI No generate
        $ti_no_generate = generate_bill_no(1, count($stat_array), 1);
        $ti_no_arr = array_combine($stat_array, $ti_no_generate);
        

    ?>    
    @foreach($invoiceData as $inv_data)
         @php
        ...
        @else
            ...
            $operator = ($inv_data->billing_date >= $cutoffDate) ? '<=' : '>=';
            $order    = ($inv_data->billing_date >= $cutoffDate) ? 'desc' : 'asc';
            $check_exits_date1 = \App\Models\Rate::whereDate('rate_date', $operator ,$inv_data->billing_date)->orderBy('rate_date', $order)->first();
        ...
        <table style="width: 545pt;padding: 20px 0;border-bottom: 1px solid #000; margin:0px auto 30px">
            <tr>
                <td style="width:85%">
                ...
                <td style="width:15%;">
                    <img src="{{asset('img/pdf-logo.png')}}" width="100">
                </td>
            </tr>
        </table>
        @endif
                        ...
                        <div style="border: 1px solid #000;width: 100%;">
                            <table cellspacing="0" style="width: 100%;" class="table-top">
                                <tr>
                                    <td style="width: 33.33%;">
                                        ...
                                        <p>
                                            {!! nl2br(e($inv_data->billing_address)) !!}
                                        </p>
                                    </td>
                                    <td style="width: 33.33%;border-left: 1px solid #000;height: 154px;">
                                        @if($inv_data->account_name < 3)
                                            <p style="text-decoration: underline;">
                                                Details of payer as a mediator
                                            </p>
                                        ...
                                        @if($inv_data->account_name == 5)
                                            ...
                                            <h3>Freelancer International Pty Limited.</h3>
                                            <p style="margin-bottom: 5px;">Level 37,</p>
                                            <p>Grosvenor Place, <br/>225 George Street, <br/>Sydney, NSW 2000 <br/>Australia</p>
                                        @endif
                                    </td>
                                                ...
                                                <td style="padding: 5px;"><b>:
                                                    @if($inv_data->account_name == 1 || $inv_data->account_name == 2)
                                                        @if(array_key_exists($inv_data->ref_id, $ti_no_arr))
                                                            @if($_REQUEST['fin_year'] == '2025-2026')
                                                    ...
                                                    @if($inv_data->account_name == 4 || $inv_data->account_name == 5)
                                                        ...
                                                        @endphp
                                                        @if(array_key_exists($inv_data->ref_id, $localti_no_arr))
                                                            @if(!isset($_GET['financial_year']) || $_GET['financial_year'] == 2025)
                                                                LC/TI{{$localti_no_arr[$inv_data->ref_id]}}
                                                            @else    
                                                                TI{{$localti_no_arr[$inv_data->ref_id]}}
                                                            @endif    
                                                        @endif
                                                    @endif
                            ...
                            <table cellspacing="0" class="priceTable" style="width: 100%;border-bottom: 1px solid #000;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 29.3%;text-align: left; height: 230px;">
                                        ...
                                        <table class="amoutPrice" cellspacing="0" style="width: 100%;">
                                            ...
                                            @if($inv_data->account_name == 4 || $inv_data->account_name == 5)
                                                ...
                                                @else
                                                    ...
                                                    <tr>
                                                        <td style="width: 50.1%;border-right: 1px solid #000;padding: 15px 5px 5px"></td>
